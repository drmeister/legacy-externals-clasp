...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -g -O2 -finline-functions -fno-strict-aliasing ' CPPFLAGS=' -D_REENTRANT -I/Users/meister/Development/chem/dependent-clasp/openmpi-1.6.5/opal/mca/hwloc/hwloc132/hwloc/include   -I/usr/include/infiniband -I/usr/include/infiniband' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/Users/meister/local/dependent-clasp/externals/common --with-mpi=open_mpi --disable-aio"
